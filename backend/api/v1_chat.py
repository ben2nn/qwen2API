...
async def chat_completions(request: Request):
    ...
    # 优先使用 context_prepared 返回的 attachments（fallback 时保留了 local_path）
    if context_prepared.get("attachments"):
        standard_request.attachments = context_prepared["attachments"]
